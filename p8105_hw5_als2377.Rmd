...
plot_2 = 
  ...
  mutate(
    mean_estimate = mean(estimate)) %>% 
  ggplot(aes(x = mu, y = mean_estimate)) + geom_point() + labs(
    title = "Avg Est. of Mu when Null is Rejected", 
    x = "True Mu",
    y = "Average Estimate of Mu"
  )
...
The sample average of mu across the tests for which the null i rejected is approximately equal to the true value of mu.